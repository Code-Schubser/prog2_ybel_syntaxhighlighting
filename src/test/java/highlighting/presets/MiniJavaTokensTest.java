...
class MiniJavaTokensTest {
  ...
  void testLineComment() {
    ...
    HighlightRegion testRegion =
        new HighlightRegion(0, testCode.length(), MiniJavaColours.LINE_COMMENT_COLOUR);
  ...
  void testJavadocComment() {
    ...
    // TestCode fuer assertEquals in ein HighlightRegion Objekt konventieren
    HighlightRegion testRegion =
        new HighlightRegion(0, testCode.length(), MiniJavaColours.JAVADOC_COMMENT_COLOUR);
  ...
  void testKeywordCommentClass() {
    ...
    // TestCode fuer assertEquals in ein HighlightRegion Objekt konventieren
    HighlightRegion testRegion =
        new HighlightRegion(0, testCode.length(), MiniJavaColours.KEYWORD_COLOUR);
  ...
  void testKAnnotationOverride() {
    ...
    // TestCode fuer assertEquals in ein HighlightRegion Objekt konventieren
    HighlightRegion testRegion =
        new HighlightRegion(0, testCode.length(), MiniJavaColours.ANNOTATION_COLOUR);
